...
module.exports = {
  ...
  options: [{
    ...
    choices: [
      ...
      { name: 'Australian Capital Territory', value: '7' },
      { name: 'New South Wales', value: '1' },
      { name: 'Northern Territory', value: '8' },
      { name: 'Queensland', value: '3' },
      { name: 'South Australia', value: '5' },
      { name: 'Tasmania', value: '6' },
      { name: 'Victoria', value: '2' },
  ...
  async execute (interaction) {
    ...
    const stateResponse = new MessageEmbed()
      ...
      .setFields([
        { name: 'Total Cases', value: `${obj[stateName].CASE_CNT}`, inline: true },
        { name: 'Active Cases', value: `${obj[stateName].ACTIVE_CNT}`, inline: true },
        { name: 'Total Deaths', value: `${obj[stateName].DEATH_CNT}`, inline: true },
        { name: 'New Local Cases (Last 24h)', value: `${obj[stateName].NEW_CASE_CNT}`, inline: true },
        { name: 'Tests (Last 24h)', value: `${newTest}`, inline: true },
        { name: 'Deaths (Last 24h)', value: `${newDeaths}`, inline: true },
        { name: 'Recovered', value: `${obj[stateName].RECOV_CNT}`, inline: true },
        { name: 'New Vaccine Doses (Last 24h)', value: `${newVaccine}`, inline: true },
        { name: 'Total Vaccine Doses', value: `${obj[stateName].VACC_DOSE_CNT}`, inline: true }
      ])
